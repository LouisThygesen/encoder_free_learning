...
if args.data == "MNIST":
    path = '/zhome/71/2/146488/bachelor_project/FID_score/MNIST_DGD'
    batches = 40
    images = 10240
if args.data == "OMNIGLOT":
    path = '/zhome/71/2/146488/bachelor_project/FID_score/OMNIGLOT_DGD'
    batches = 32
    images = 8192

# Function for creating data loader 
def load_data():
    if args.data == "MNIST":
...
# Load model 
if args.data == "MNIST":
    model.load_state_dict(torch.load('saved_models/model_MNIST_DGD.pth'))

if args.data == "OMNIGLOT":
    model.load_state_dict(torch.load('saved_models/model_OMNIGLOT_DGD.pth'))
