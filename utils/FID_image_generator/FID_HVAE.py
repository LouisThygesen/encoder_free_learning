...
if args.data == "MNIST":
    path = '/zhome/71/2/146488/bachelor_project/FID_score/MNIST_HVAE'
    batches = 40
    images = 10240
    sl = 5
if args.data == "OMNIGLOT":
    path = '/zhome/71/2/146488/bachelor_project/FID_score/OMNIGLOT_HVAE'
    batches = 32
    images = 8192
    sl = 5
...
# Load model 
if args.data == "MNIST":
    model.load_state_dict(torch.load('saved_models/model_MNIST_HVAE.pth'))
if args.data == "OMNIGLOT":
    model.load_state_dict(torch.load('saved_models/model_OMNIGLOT_HVAE.pth'))
