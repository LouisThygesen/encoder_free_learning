...
# Set limits
min_train_loss = min(df2['train_loss'][50:].min(),df3['train_loss'][50:].min(),df4['train_loss'][50:].min(),df5['train_loss'][50:].min())
max_train_loss = max(df2['train_loss'][50:].max(),df3['train_loss'][50:].max(),df4['train_loss'][50:].max(),df5['train_loss'][50:].max())
...
# Set limits
min_val1_loss = min(df2['val1_loss'][50:].min(),df3['val1_loss'][50:].min(),df4['val1_loss'][50:].min(),df5['val1_loss'][50:].min())
max_val1_loss = max(df2['val1_loss'][50:].max(),df3['val1_loss'][50:].max(),df4['val1_loss'][50:].max(),df5['val1_loss'][50:].max())
...
# Set limits
min_val2_loss = min(df2['val2_loss'][50:].min(),df3['val2_loss'][50:].min(),df4['val2_loss'][50:].min(),df5['val2_loss'][50:].min())
max_val2_loss = max(df2['val2_loss'][50:].max(),df3['val2_loss'][50:].max(),df4['val2_loss'][50:].max(),df5['val2_loss'][50:].max())
...
axs[2].legend(['SL2','SL3','SL4','SL5'], fontsize=18)
